...
#broken
#logging.basicConfig(level=logging.INFO, filename='/var/www/html/Material-Requirements-Planning-System/server/logs/MRP.log', format='%(asctime)s %(message)s')
...
if not application.debug:
    ...
    logdir = '/var/www/html/Material-Requirements-Planning-System/server/logs/'
