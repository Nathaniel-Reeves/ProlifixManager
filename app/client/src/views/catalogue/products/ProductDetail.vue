    ...
    <b-container fluid class="p-0">
      ...
      <b-card class="my-2" v-if="loaded" style="box-shadow: 0 20px 40px rgba(0,0,0,.2);">
        <b-card-body id="nav-scroller" ref="content" class="scrollbox">
          ...
          <div v-show="activeSection('formula_docs')">
          ...
          <hr v-show="activeSection('formula_docs')">
          <ProductManufacturing
            ...
            v-on:refresh-parent="(v) => refreshParent(v)"
          ></ProductManufacturing>
          <hr v-show="activeSection('manufacturing')">
          <div v-show="activeSection('manufacturing_docs')">
          ...
          <hr v-show="activeSection('manufacturing_docs')">
