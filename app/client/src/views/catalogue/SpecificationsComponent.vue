<template>
  <div v-if="doc.specifications !== undefined">
    ...
    <div v-for="(spec, spec_key, index) in doc.specifications.specs" :key="index">
      <div :class="[spec_key != 'example_cofas' ? 'd-print-block' : 'd-print-none']" style="break-inside: avoid;">
          ...
          <div v-if="!edit_specs">
            <b-card-group deck v-if="useCardType(spec_key)">
              <div v-for="test, test_key, index in spec.tests" :key="index">
                <b-card no-body style="max-width: 25rem;" :class="['my-3', 'no-shaddow', index < 4 ? 'd-print-flex' : 'd-print-none']">
          ...
          <div v-if="edit_specs">
            <b-card-group deck v-if="useCardType(spec_key)">
              <div v-for="( test, index ) in edit_specs_buffer.specs[spec_key].tests" :key="index">
                <b-card no-body style="max-width: 25rem; min-width: 25rem;" :class="['my-3', 'no-shaddow', index < 4 ? 'd-print-flex' : 'd-print-none']">
              ...
              <b-card v-if="spec_key === 'microscopic'" img-src="../../assets/no_image_placeholder.png" :class="['my-3', 'no-shaddow', index < 4 ? 'd-print-flex' : 'd-print-none']"
              ...
              <b-card v-else-if="spec_key === 'organoleptic'" :class="['my-3', 'no-shaddow', index < 4 ? 'd-print-flex' : 'd-print-none']" style="max-width: 25rem; min-width: 25rem; cursor: pointer;"
