...
<template>
  <div class="my_component d-flex flex-wrap justify-content-center">
    <div class="card my-2" style="width: 1250px;height: 850px">
      <div class="card-body">
        <div class="d-flex justify-content-center" style="width: 1200px;height: 800px">
          <VueFlow :nodes="nodes" :edges="edges" :class="{ dark }" class="basicflow" fit-view-on-init :default-viewport="{ zoom: 1.5 }" :min-zoom="0.2"
            :max-zoom="4">
