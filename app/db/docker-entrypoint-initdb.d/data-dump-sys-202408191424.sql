...
--
-- Host: 192.168.1.133    Database: sys
-- ------------------------------------------------------
...
INSERT INTO `sys_config` VALUES ('statement_truncate_len','64','2023-09-12 17:15:26',NULL),('statement_performance_analyzer.limit','100','2023-09-12 17:15:26',NULL),('statement_performance_analyzer.view',NULL,'2023-09-12 17:15:26',NULL),('diagnostics.allow_i_s_tables','OFF','2023-09-12 17:15:26',NULL),('diagnostics.include_raw','OFF','2023-09-12 17:15:26',NULL),('ps_thread_trx_info.max_length','65535','2023-09-12 17:15:26',NULL);
...
DELIMITER ;;
CREATE DEFINER=`client`@`%` FUNCTION `LEVENSHTEIN`(s1 VARCHAR(255), s2 VARCHAR(255)) RETURNS int(11)
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`client`@`%` FUNCTION `LEVENSHTEIN_RATIO`(s1 VARCHAR(255), s2 VARCHAR(255)) RETURNS decimal(3,0)
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`mariadb.sys`@`localhost` FUNCTION `quote_identifier`(in_identifier TEXT) RETURNS text CHARSET utf8mb3 COLLATE utf8mb3_general_ci
    NO SQL
    DETERMINISTIC
    SQL SECURITY INVOKER
...
-- Dump completed on 2024-08-19 14:24:44
