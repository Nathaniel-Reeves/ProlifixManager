...
class Test_DB(unittest.TestCase):
	...
	def setUp(self):
		...
		self.connection = pimysql.connector.connect(host=HOST, user=USER, password=PASSWORD)
		...
		sql_query_temp = 'INSERT INTO store.customers(first_name, last_name, age, birthday, is_deleted) VALUES ( %s, %s, %s, %s, %s );'
		data = [
		('billy','tanner',22, date(2000, 4, 26), 0),
		('paul','anderson', 40, date(2000, 4, 26), 0),
		('tom','victor', 35, date(2000, 4, 26), 0),
		('paul','joe',40, date(2000, 4, 26), 1),
		('jimmy','bawlen', 34, date(2000, 4, 26), 0)
		]
	...
	def test_getItem(self):
		...
		self.assertEqual(db4.getItem(item_id = 1, returnDicts=True),{'customer_id':1, 'first_name':'billy', 'last_name':'tanner', 'age':22, 'birthday': datetime.date(2000, 4, 26), 'is_deleted':0})
	...
	def test_getItems(self):
		...
		db4 = Database(database='store', table='customers')
		self.assertEqual(db4.getItems(),[(1, 'billy', 'tanner', 22, datetime.date(2000, 4, 26), 0),(2, 'paul', 'anderson', 40, datetime.date(2000, 4, 26), 0),(3, 'tom', 'victor', 35, datetime.date(2000, 4, 26), 0),(4, 'paul', 'joe', 40, datetime.date(2000, 4, 26), 1),(5, 'jimmy', 'bawlen', 34, datetime.date(2000, 4, 26), 0)])
		self.assertEqual(db4.getItems(returnDicts=True),[{'customer_id':1, 'first_name':'billy', 'last_name':'tanner', 'age':22, 'birthday': datetime.date(2000, 4, 26), 'is_deleted':0},{'customer_id':2, 'first_name':'paul', 'last_name':'anderson', 'age':40, 'birthday': datetime.date(2000, 4, 26), 'is_deleted':0},{'customer_id':3, 'first_name':'tom', 'last_name':'victor', 'age':35, 'birthday': datetime.date(2000, 4, 26), 'is_deleted':0},{'customer_id':4, 'first_name':'paul', 'last_name':'joe', 'age':40, 'birthday': datetime.date(2000, 4, 26), 'is_deleted':1},{'customer_id':5, 'first_name':'jimmy', 'last_name':'bawlen', 'age':34, 'birthday': datetime.date(2000, 4, 26), 'is_deleted':0}])
	...
	def test_insertItem(self):
		...
		self.assertTrue(db.insertItem(({'first_name':'tommy','last_name':'tyson','age':26, 'birthday': datetime.date(2000, 4, 26)})))
	...
	def test_getDate(self):
		db = Database(database='store', table='customers', autoCommit=False)
		#print(db.getItems())
	...
	def test_useCase2(self):
		...
		self.assertEqual(db_1a.getItems(),[(1, 'billy', 'tanner', 22, datetime.date(2000, 4, 26), 0), (2, 'paul', 'anderson', 40, datetime.date(2000, 4, 26), 0), (3, 'tom', 'victor', 35, datetime.date(2000, 4, 26), 0), (4, 'paul', 'joe', 40, datetime.date(2000, 4, 26), 1), (5, 'jimmy', 'bawlen', 34, datetime.date(2000, 4, 26), 0)])
		...
		self.assertTrue(db_1a.insertItem({'age':52, 'birthday': datetime.date(2000, 4, 26),'first_name':'kevin','last_name':'bernard'}))
		...
		self.assertEqual(db_1a.getItemFKs(id=3),[])
		self.assertEqual(db_1a.getItems(),[(1, 'billy', 'tanner', 22, datetime.date(2000, 4, 26), 0), (2, 'paul', 'anderson', 40, datetime.date(2000, 4, 26), 0), (3, 'tom', 'victor', 35, datetime.date(2000, 4, 26), 0), (4, 'paul', 'joe', 40, datetime.date(2000, 4, 26), 1), (5, 'jimmy', 'bawlen', 34, datetime.date(2000, 4, 26), 0), (6, 'kevin', 'bernard', 52, datetime.date(2000, 4, 26), 0)])
		self.assertTrue(db_1a.switchTable('products'))
		self.assertEqual(db_1a.getItem(item_id='NLS2q34345', columns=['product_name', 'brand_name']),('Milk', 'MerryGold'))
		self.assertEqual(db_1a.getItemPKs(),['134SBE2341', 'HBO34523', 'NLS2q34345'])
		self.assertEqual(db_1a.getItemFKs(id='NLS2q34345'),[])
		...
		self.assertEqual(db_1b.getItems(),[(1, 'billy', 'tanner', 22, datetime.date(2000, 4, 26), 0), (2, 'paul', 'anderson', 40, datetime.date(2000, 4, 26), 0), (3, 'tom', 'victor', 35, datetime.date(2000, 4, 26), 0), (4, 'paul', 'joe', 40, datetime.date(2000, 4, 26), 1), (5, 'jimmy', 'bawlen', 34, datetime.date(2000, 4, 26), 0)])
	...
	def test_useCase3(self):
		...
		self.assertEqual(db_2a.getItems(),[(1, 'billy', 'tanner', 22, datetime.date(2000, 4, 26), 0), (2, 'paul', 'anderson', 40, datetime.date(2000, 4, 26), 0), (3, 'tom', 'victor', 35, datetime.date(2000, 4, 26), 0), (4, 'paul', 'joe', 40, datetime.date(2000, 4, 26), 1), (5, 'jimmy', 'bawlen', 34, datetime.date(2000, 4, 26), 0)])
		...
		self.assertEqual(db_2b.getItems(),[(1, 'billy', 'tanner', 22, datetime.date(2000, 4, 26), 0), (2, 'paul', 'anderson', 40, datetime.date(2000, 4, 26), 0), (3, 'tom', 'victor', 35, datetime.date(2000, 4, 26), 0), (4, 'paul', 'joe', 40, datetime.date(2000, 4, 26), 1), (5, 'jimmy', 'bawlen', 34, datetime.date(2000, 4, 26), 0)])
